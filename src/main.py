...
def get_llm() -> BaseLanguageModel:
    ...
    - If LLM mocking is enabled, it configures the model to use the mock server.
    ...
    llm_mock_url = os.environ.get("LLM_MOCK_URL", "https://rancher-ai-llm-mock")
    if active and llm_mock_enabled:
        logging.info(f"Using LLM Mock server at {llm_mock_url}")
