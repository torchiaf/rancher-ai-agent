...
class RedisClient:
    ...
    async def fetch(self, session_id: str, max_count: int, reverse: bool = False) -> list[str]:
        ...
        try:
            ...
            try:
                ...
                # Select the tail or head depending on reverse flag
                if reverse:
                    # Most recent N: take from the end
                    keys = all_keys[-max_count:][::-1]
                else:
